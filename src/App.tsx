          ...
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_340px] gap-10 lg:gap-12 items-center">
            ...
            <div className="max-w-[640px]">
              ...
              <p className="text-[0.95rem] text-text-primary/70 leading-relaxed mb-8 animate-blur-fade delay-200 max-w-[640px]">
                7 лет в строительстве + 2 года в прикладном AI. Прохожу весь путь сам — от боли на площадке до production: сильнее всего в AI-ядре (домен, данные, поиск, агентные пайплайны, метрики), но собираю продукт целиком. Без «сломанного телефона» между бизнесом и IT. Ниже — продукты и как они устроены.
              </p>
            </div>
